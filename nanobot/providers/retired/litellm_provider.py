...
class LiteLLMProvider(LLMProvider):
    ...
    def __init__(
        ...
        # NOTE: Do NOT set litellm.api_base here — it's a global variable
        # that leaks across providers and causes "Model not found" errors
        # when testing different providers. Per-request api_base in chat()
        # kwargs is the correct approach. (See log 2026-03-12_1330)
    ...
    def _build_chat_kwargs(
        ...
        # Pass api_base per-request (NOT set globally — see log 2026-03-12_1330)
        if self.api_base:
